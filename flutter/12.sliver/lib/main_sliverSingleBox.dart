...
void main() {
  runApp(MaterialApp(
    home: Scaffold(
      body: SliverSingleBoxDemo(),
    ),
  ));
}

class SliverSingleBoxDemo extends StatelessWidget {
...
class _SliverEventTile extends SingleChildRenderObjectWidget {
  ...
  _SliverEventTile({this.child}) : super(child: child);
...
class _EventTile extends StatefulWidget {
  final _Event m;
  static final df = DateFormat.yMd().add_jm();
    ...
    return Card(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 8),
          Text('${_EventTile.df.format(widget.m.time)} * ${widget.m.location}',
              style: Theme.of(context)
                  .textTheme
                  .subtitle2
                  .copyWith(color: Colors.white)),
