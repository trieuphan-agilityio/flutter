...
/// where possible.
class AdminTemplateAnalyzerPlugin extends ServerPlugin {
  final Checker checker = Checker();

  AdminTemplateAnalyzerPlugin(ResourceProvider provider) : super(provider);
  ...
  @override
  String get name => 'Admin Template';
  ...
  String get contactInfo =>
      'https://gitlab.asoft-python.com/g-sangdong/dart-training/-/issues';
