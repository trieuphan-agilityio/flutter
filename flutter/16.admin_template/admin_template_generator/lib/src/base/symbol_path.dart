...
class SymbolPath implements Comparable<SymbolPath> {
  /// Path to the `@AgFormTemplate` annotation.
  static const agFormTemplate = const SymbolPath._standard('AgFormTemplate');
  ...
  /// For standard annotations defined by `package:admin_template`.
  const SymbolPath._standard(String symbol)
      : this._('admin_template', 'admin_template.dart', symbol);
