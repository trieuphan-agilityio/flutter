...
class _BackdropTitle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final menuButtonTooltip = animation.isCompleted
        ? AppLocalizations.of(context).shrineTooltipOpenMenu
        : animation.isDismissed
            ? AppLocalizations.of(context).shrineTooltipCloseMenu
            : null;
    ...
    final appBar = AppBar(
      ...
      actions: [
        ...
        IconButton(
          ...
          tooltip: AppLocalizations.of(context).shrineTooltipSettings,
          onPressed: () {},
        ),
      ],
    );
