...
Category categoryAll = Category(
  name: (context) => AppLocalizations.of(context).shrineCategoryNameAll,
);

Category categoryAccessories = Category(
  name: (context) => AppLocalizations.of(context).shrineCategoryNameAccessories,
);

Category categoryClothing = Category(
  name: (context) => AppLocalizations.of(context).shrineCategoryNameClothing,
);

Category categoryHome = Category(
  name: (context) => AppLocalizations.of(context).shrineCategoryNameHome,
);
